...
IF(INPUT_TYPE EQ 'CUSTOM') OR (INPUT_TYPE EQ 'custom')THEN BEGIN 
  DIMG_file= '/kingair_data/hcpi20/OAP_processed/20200810/DIMG.20200810202655.2DS.V.cdf' ;ex. '/kingair_data/hcpi20/OAP_processed/20200811/DIMG.200811193926.2DS.H.cdf'
  PROC_file= '/kingair_data/hcpi20/OAP_processed/20200810/PROC.20200810202655.2DS.V.cdf' ;ex  '/kingair_data/hcpi20/OAP_processed/20200811/PROC.200811193926.2DS.H.cdf'
  DATE= 20200810  ;ex. 20200811
  Start_time_sec= 76455  ;these need to be in sec, ex. 720936
  End_time_sec=   76490  ;make sure start time is less then end time
  Output_file_path= '/home/medwar29/Desktop/cloud_part_imgs/aug_10_CPI/ar_check/' ;the actuall name of the file will set at the end of the file automaticaly. We need the start/end times in hhmmss first.
