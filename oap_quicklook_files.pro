FUNCTION OAP_QUICKLOOK_FILES, STARTING_VARIABLES, DELETE_FILE, FILE_DELETE_STOP_VARIABLE, File_run

;this step unpacks the varaibles that we created in OAP_QUICKLOOK_GETSETUP function
...
OUTPUT_FILE_PATH=STARTING_VARIABLES.FIELD10
OUTPUT_FILE_TYPE=STARTING_VARIABLES.FIELD11
...
If Stop_variable EQ 'on' THEN BEGIN
  FILE_VARIABLES= CREATE_STRUCT('Stop_varaible', Stop_variable)
